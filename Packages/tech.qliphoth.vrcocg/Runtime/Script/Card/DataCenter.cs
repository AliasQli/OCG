...
namespace VRCOCG {
    ...
    public class DataCenter : UdonSharpBehaviour
    {
        ...
        public Material cardNormal;
        public Material cardShiny;
        public Material cardRoyal;
        ...
        int GetMaterialIndex(double code)
        {
            return (int)(code * 10) % 10;
        }

        public Material GetMaterial(double code)
        {
            switch (GetMaterialIndex(code))
            {
                case 0:
                    return cardNormal;
                case 1:
        ...
        public bool IsKiraMaterial(double code)
        {
            return GetMaterialIndex(code) != 0;
        }

        public DataDictionary Get(double code)
        {
            var s = $"{(int)code}";
